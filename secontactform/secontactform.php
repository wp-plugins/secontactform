...
function contactform_func($atts, $content){
  ...
  if(get_option('isms_name')=="1"){
    $outputData .='<div><label>'.(get_option('isms_name_required')=="1"?"<input type='hidden' id='isms_name_required' value='1'>* ":"")
                .'Full Name</label><input type="text" name="iname" id="iname"/></div>';
  }
  if(get_option('isms_first_name')=="1"){
    $outputData .='<div><label>'.(get_option('isms_first_name_required')=="1"?"<input type='hidden' id='isms_first_name_required' value='1'>* ":"")
                .'First Name</label><input type="text" name="ifirstname" id="ifirstname"/></div>';
  }
  if(get_option('isms_last_name')=="1"){
    $outputData .='<div><label>'.(get_option('isms_last_name_required')=="1"?"<input type='hidden' id='isms_last_name_required' value='1'>* ":"")
                .'Last Name</label><input type="text" name="ilastname" id="ilastname"/></div>';
  }
  ...
  if(get_option('isms_email')=="1"){
    $outputData .='<div><label>'.(get_option('isms_email_required')=="1"?"<input type='hidden' id='isms_email_required' value='1'>* ":"")
                .'Email</label><input type="text" name="iemail" id="iemail"/></div>';
  }
  if(get_option('isms_reemail')=="1"){
    $outputData .='<div><label>'.(get_option('isms_reemail_required')=="1"?"<input type='hidden' id='isms_reemail_required' value='1'>* ":"")
                .'Reconfirm Email</label><input type="text" name="ireemail" id="ireemail"/></div>';
  } 
  if(get_option('isms_address')=="1"){
    $outputData .='<div><label>'.(get_option('isms_address_required')=="1"?"<input type='hidden' id='isms_address_required' value='1'>* ":"")
                .'Address</label><input type="text" name="iaddress" id="iaddress"/></div>';
  }   
  if(get_option('isms_country')=="1"){
    $outputData .='<div><label>'.(get_option('isms_country_required')=="1"?"<input type='hidden' id='isms_country_required' value='1'>* ":"")
                .'Country</label><input type="text" name="icountry" id="icountry"/></div>';
  }     
  if(get_option('isms_passport_no')=="1"){
    $outputData .='<div><label>'.(get_option('isms_passport_no_required')=="1"?"<input type='hidden' id='isms_passport_no_required' value='1'>* ":"")
                .'Passport No.</label><input type="text" name="ipassport" id="ipassport"/></div>';
  }       
  if(get_option('isms_social_security_no')=="1"){
    $outputData .='<div><label>'.(get_option('isms_social_security_no_required')=="1"?"<input type='hidden' id='isms_social_security_no_required' value='1'>* ":"")
                .'Social Security No.</label><input type="text" name="isocial_security_no" id="isocial_security_no"/></div>';
  }       
  if(get_option('isms_dob')=="1"){
    $outputData .='<div><label>'.(get_option('isms_dob_required')=="1"?"<input type='hidden' id='isms_dob_required' value='1'>* ":"")
                .'Date of Birth</label><input type="text" name="idob" id="idob"/>(dd/mm/yyyy)</div>';
  }         
  if(get_option('isms_company')=="1"){
    $outputData .='<div><label>'.(get_option('isms_company_required')=="1"?"<input type='hidden' id='isms_company_required' value='1'>* ":"")
                .'Company</label><input type="text" name="icompany" id="icompany"/></div>';
  }
  if(get_option('isms_product')=="1"){
    $outputData .='<div><label>'.(get_option('isms_product_required')=="1"?"<input type='hidden' id='isms_product_required' value='1'>* ":"")
                .'Product</label><input type="text" name="iproduct" id="iproduct"/></div>';
  }  
  if(get_option('isms_website')=="1"){
    $outputData .='<div><label>'.(get_option('isms_website_required')=="1"?"<input type='hidden' id='isms_website_required' value='1'>* ":"")
                .'Website</label><input type="text" name="iwebsite" id="iwebsite"/></div>';
  }   

  if(get_option('isms_custom1')=="1"){
    $outputData .='<div><label>'.(get_option('isms_custom1_required')=="1"?"<input type='hidden' id='isms_custom1_required' value='1'>* ":"")
                .get_option('isms_custom_name1').'</label>'.generate_custom_fieldtype("cisms_custom_name1", get_option('isms_custom_type1')).'</div>';
  }   
  if(get_option('isms_custom2')=="1"){
    $outputData .='<div><label>'.(get_option('isms_custom2_required')=="1"?"<input type='hidden' id='isms_custom2_required' value='1'>* ":"")
                .get_option('isms_custom_name2').'</label>'.generate_custom_fieldtype("cisms_custom_name2", get_option('isms_custom_type2')).'</div>';
  }
  if(get_option('isms_custom3')=="1"){
    $outputData .='<div><label>'.(get_option('isms_custom3_required')=="1"?"<input type='hidden' id='isms_custom3_required' value='1'>* ":"")
                .get_option('isms_custom_name3').'</label>'.generate_custom_fieldtype("cisms_custom_name3", get_option('isms_custom_type3')).'</div>';
  }
  if(get_option('isms_custom4')=="1"){
    $outputData .='<div><label>'.(get_option('isms_custom4_required')=="1"?"<input type='hidden' id='isms_custom4_required' value='1'>* ":"")
                .get_option('isms_custom_name4').'</label>'.generate_custom_fieldtype("cisms_custom_name4", get_option('isms_custom_type4')).'</div>';
  }
  if(get_option('isms_custom5')=="1"){
    $outputData .='<div><label>'.(get_option('isms_custom5_required')=="1"?"<input type='hidden' id='isms_custom5_required' value='1'>* ":"")
                .get_option('isms_custom_name5').'</label>'.generate_custom_fieldtype("cisms_custom_name5", get_option('isms_custom_type5')).'</div>';
  }

  if(get_option('isms_custom_select1')=="1"){
    $outputData .='<div><label>'.(get_option('isms_custom_select1_required')=="1"?"<input type='hidden' id='isms_custom_select1_required' value='1'>* ":"")
                .get_option('isms_custom_select_name1').'</label>'.generate_custom_select_option("cisms_custom_select_name1", get_option('isms_custom_select_option1')).'</div>';
  }
  if(get_option('isms_custom_select2')=="1"){
    $outputData .='<div><label>'.(get_option('isms_custom_select2_required')=="1"?"<input type='hidden' id='isms_custom_select2_required' value='1'>* ":"")
                .get_option('isms_custom_select_name2').'</label>'.generate_custom_select_option("cisms_custom_select_name2", get_option('isms_custom_select_option2')).'</div>';
  }
  if(get_option('isms_custom_select3')=="1"){
    $outputData .='<div><label>'.(get_option('isms_custom_select3_required')=="1"?"<input type='hidden' id='isms_custom_select3_required' value='1'>* ":"")
                .get_option('isms_custom_select_name3').'</label>'.generate_custom_select_option("cisms_custom_select_name3", get_option('isms_custom_select_option3')).'</div>';
  }
  if(get_option('isms_subject')=="1"){
    $outputData .='<div><label>'.(get_option('isms_subject_required')=="1"?"<input type='hidden' id='isms_subject_required' value='1'>* ":"")
  ...
  if(get_option('isms_captcha')=="1"){
    ...
    $outputData .='<div><label>Captcha</label><input type="text" name="captchatxt" id="captchatxt" /></div>';
  }
  
  $outputData .='<div><label>&nbsp;</label><input type="submit" value="Submit" onclick="return validate();"/></div>';
  $outputData .='</fieldset>'; 
      ...
      if($captcha_valid && $no_error){
        ...
        if(strlen(get_option('notification_email')) > 10){
          if(get_option('isms_smtp_notification') == 1 && get_option('isms_smtp_host') != "" && get_option('isms_smtp_username') != "" && get_option('isms_smtp_password') != "" && get_option('isms_smtp_email') != ""){
            ...
            if(get_option('isms_smtp_ssl') == 1){
			$smtp_port = '465';
			if(strlen(get_option('isms_smtp_port')>0)) $smtp_port = get_option('isms_smtp_port');
			$host = "ssl://".$host.":".$smtp_port;
		}
		else{
			
			if(strlen(get_option('isms_smtp_port')>0)) $mail->Port = get_option('isms_smtp_port');
		}
            ...
            if(strlen(get_option('notification_cc')) > 10){
			
			$multipleDestCC_arr=split(";",get_option('notification_cc'));
			
			foreach ($multipleDestCC_arr as $multipleDestCC){
				$mail->AddCC(trim($multipleDestCC), trim($multipleDestCC));              
			}
		}
            
            if(strlen(get_option('notification_bcc')) > 10){
			
			$multipleDestBCC_arr=split(";",get_option('notification_bcc'));
			
			foreach ($multipleDestBCC_arr as $multipleDestBCC){
				$mail->AddBCC(trim($multipleDestBCC), trim($multipleDestBCC));              
			}
		}
            ...
            mail(str_replace(";", ",", get_option('notification_email')), get_option('form_subject')."-", $message, 'From: "Contact Form" <'.get_option('notification_email').">\r\n");
          }
        }
...
function register_mysettings(){
  ...
  register_setting( 'email-sms-settings-group', 'isms_smtp_port' );
  register_setting( 'email-sms-settings-group', 'notification_email' );
  register_setting( 'email-sms-settings-group', 'notification_cc' );
  register_setting( 'email-sms-settings-group', 'notification_bcc' );
  /////
      ...
      <tr>
        ...
        <td valign="top">
          ...
          <legend>Email</legend>
            ...
            <div><label>SMTP port</label><input name="isms_smtp_port" type="text" id="isms_smtp_port" value="<?php echo get_option('isms_smtp_port'); ?>" /><span>Leave empty for default(Default: 25, 465 for SSL)</span></div>
            ...
            <div><label>CC</label>
              <textarea name="notification_cc" id="notification_cc" cols="45" rows="5"><?php echo get_option('notification_cc'); ?></textarea>
              <span>Please use semicolon ; to separate multiple recipient</span>
            </div>
            <div><label>BCC</label>
              <textarea name="notification_bcc" id="notification_bcc" cols="45" rows="5"><?php echo get_option('notification_bcc'); ?></textarea>
              <span>Please use semicolon ; to separate multiple recipient</span>
            </div>
          </fieldset>
        </td>
